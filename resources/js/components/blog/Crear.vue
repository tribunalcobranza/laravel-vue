...
export default {
    ...
    methods:{
        async crear(){
            await this.axios.post('/api/blog',this.blog).then(response=>{ //Enviaremos los datos que capturemos del formulario del v.model (Lo que capturamos arriba)
